          ...
          >
            ...
            <div className="flex items-start justify-between px-5 pt-2">
              ...
              <button
                ...
                aria-label="Cancel"
                className="icon-button -mr-2 -mt-1 text-fg-muted hover:text-fg flex-shrink-0"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <div className="px-3 pt-3 pb-[max(1rem,env(safe-area-inset-bottom))] space-y-1.5">
              <button
                ...
                className="pressable w-full flex items-center gap-3 px-3 min-h-[56px] rounded-xl bg-surface-1 hover:bg-surface-hover transition-colors"
              >
              ...
              <button
                ...
                className="pressable w-full flex items-center justify-center min-h-[44px] rounded-xl text-sm text-fg-muted hover:text-fg transition-colors"
              >
