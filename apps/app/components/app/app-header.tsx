...
export function AppHeader() {
  ...
  return (
    <>
      ...
      {/* Bottom nav — mobile */}
      <nav className="lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-trail-950/98 backdrop-blur-xl pb-[max(0.625rem,env(safe-area-inset-bottom))]" style={{ boxShadow: "0 -1px 0 rgba(255,255,255,0.04)" }}>
